                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <small>Aqui se encuentran todas las sesiones del sistema</small>
                            </h2>
                        </div>
                        <br>
...
<div class="container-fluid">
    <div class="col-xs-12">
         <div class="body table-responsive">
                          <table id="tbactividad" class="table table-bordered table-striped table-condensed flip-content">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/main_js/bitacora_actividad.js"></script>
