            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            Carrousel
                            <small>Aqui podras editar toda la información de los carrousels</small>
                        </h2>
                    ...
                    <div class="container-fluid">
                        <div class="col-xs-12">
                            <div class="body table-responsive">
                                <table id="tb-carr" class="table table-bordered table-striped table-condensed">
                                    <thead class="">
                                        <tr>
                                            <th>CORRELATIVO</th>
                                            <th>TITULO</th>
...
<div class="modal fade" id="create_form_modal" data-backdrop="static" data-keyboard="false" role="dialog" tabindex="-1">
    <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-body users-cont">
                        <div class="row clearfix">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="file" class="form-control date" placeholder="Foto Carrousel" name="foto" id="foto">
                                </div>
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/main_js/carrousel.js"></script>